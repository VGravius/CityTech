...
2. Выберите файл `grpcurl_1.9.3_windows_x86_64.zip`.
3. Распакуйте архив в удобную папку (например, `C:\dev\grpcurl\`).
4. Добавьте путь к папке в переменную окружения `PATH` или используйте полный путь при вызове.
